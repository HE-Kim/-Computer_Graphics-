...
void InitCarModel()
{
	g_car_mesh.ReadObjFormatFile("../Data/rabbit.obj");
	...
	g_car_mesh.ScaleVertices(glm::vec3(10.f, 15.f, 10.f));
	g_car_mesh.RotateVertices(glm::radians(-90.f), glm::vec3(1, 0, 0));
	g_car_mesh.RotateVertices(glm::radians(270.f), glm::vec3(0, 1, 0));
	g_car_mesh.SetColor(0.9f, 0.9f,1.f, 1);
